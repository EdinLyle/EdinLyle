...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Location-China-ff69b4?style=for-the-badge&logo=google-maps&logoColor=white" alt="Location"/>
  <img src="https://img.shields.io/badge/CSDN-Blog%20Star%20Top1%25-red?style=for-the-badge&logo=blog&logoColor=white" alt="CSDN"/>
</p>
...
<!-- 技能图标 -->
<p align="center">
  <img src="https://skillicons.dev/icons?i=python,java,linux,bash,docker,kubernetes,git,github,md,mysql&theme=dark" alt="Tech Stack"/>
</p>

### 🔒 安全领域
- **工业安全 (OT Security)**：工控设备防护、产线安全运营、ICS 威胁响应
- **应急响应 (Incident Response)**：挖矿/勒索/内存马处置、Root Cause 分析、SOP 制定
- **安全运营 (SOC)**：7×24 重保值守、多厂商安全设备 (EDR/XDR/NDR) 运营
- **渗透测试**：Web 渗透、漏洞挖掘、SRC 漏洞提交 (CNVD/补天/教育 SRC/企业SRC)

### 🛠️ 技术能力
- **安全工具开发**：Python/Tkinter GUI 工具、自动化脚本、漏洞扫描器
...
<table>
  <tr>
    <td width="50%">
      <h3 align="center">🔧 安全运营自动化工具集</h3>
      <div align="center">
        <a href="[项目1仓库链接]"><!-- 替换为具体仓库地址 -->
          <img src="https://img.shields.io/badge/Python-Tkinter%20GUI-3776AB?style=for-the-badge&logo=python&logoColor=white" alt="Python Tools"/>
        </a>
        <p>针对多厂商安全设备的 GUI 自动化工具，支持挖矿告警筛选、批量导出、智能分析，降低人工工作量 70%</p>
      </div>
    </td>
    <td width="50%">
      <h3 align="center">🛡️ 应急响应脚本库</h3>
      <div align="center">
        <a href="[项目2仓库链接]"><!-- 替换为具体仓库地址 -->
          <img src="https://img.shields.io/badge/Shell-Linux%20%26%20Windows-4EAA25?style=for-the-badge&logo=gnu-bash&logoColor=white" alt="IR Scripts"/>
        </a>
        <p>挖矿/勒索/内存马应急响应脚本集合，支持 Windows/Linux 双平台，30 分钟内完成隔离+取证+清除</p>
      </div>
    </td>
  </tr>
  <tr>
    <td width="50%">
      <h3 align="center">🏭 工业安全解决方案</h3>
      <div align="center">
        <a href="[项目3仓库链接]"><!-- 替换为具体仓库地址 -->
          <img src="https://img.shields.io/badge/OT%20Security-HIDS%20%26%20EDR-00D9FF?style=for-the-badge&logo=shield&logoColor=white" alt="OT Security"/>
        </a>
        <p>工厂产线安全运营方案，HIDS 部署、火绒兼容性优化、供应链准入审计平台，实现蠕虫/挖矿 0 驻留</p>
      </div>
    </td>
    <td width="50%">
      <h3 align="center">📚 安全知识库</h3>
      <div align="center">
        <a href="[项目4仓库链接]"><!-- 替换为具体仓库地址 -->
          <img src="https://img.shields.io/badge/Markdown-Knowledge%20Base-000000?style=for-the-badge&logo=markdown&logoColor=white" alt="Knowledge Base"/>
        </a>
        <p>Web 渗透、漏洞复现、应急响应 SOP、安全设备操作手册等技术沉淀</p>
      </div>
    </td>
  </tr>
</table>
...
<p align="center">
  <img src="https://quotes-github-readme.vercel.app/api?type=horizontal&theme=tokyonight&quote=自动化是安全运营的终极答案，代码是应急响应的最好武器&author=EdinLyle" alt="Quote"/>
</p>
